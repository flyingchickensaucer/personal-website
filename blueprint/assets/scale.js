// Numbers under the sheet's top dimension scale.
// The ticks (drawn in CSS on .plate::after) sit 28px apart starting 16px in
// from the frame. We label every 5th tick to match.
(function () {
